    ...
    >
      <div className="mx-auto w-full max-w-md px-6 py-8">
        ...
        <header className="mb-8 px-2">
          ...
          <p className="mt-3 text-[14px] leading-relaxed text-[#a0a0a0]">
        ...
        {sent ? (
          <div className="rounded-[24px] border border-[#1a1a1a] bg-[#1a1a1a]/40 p-8 text-center">
            ...
            <p className="mt-2 text-[13.5px] leading-relaxed text-[#a0a0a0]">
              {tx("Thanks")} {name.split(" ")[0]}. {tx("We'll reply to")}{" "}
              <b className="font-medium text-[#f5f5f5]">{email}</b>{" "}
              {tx("within 24 hours.")}
            </p>
            <button
              onClick={() => setSent(false)}
              className="mt-6 text-[13px] font-medium text-[#f5f5f5] underline underline-offset-4"
            >
            ...
            <section className="mb-8">
              ...
              >
                <div className="flex flex-col">
                  ...
                  <span className="mt-1 text-[15px] font-medium text-[#f5f5f5]">
                    support@megsyai.com
                  </span>
                </div>
