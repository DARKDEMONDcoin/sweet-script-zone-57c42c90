...
const PlusMain = (p: PlusContentProps) => {
  ...
  const mobileRows: MobileRow[] = [
    ...
    },
    {
      id: "_skills",
      label: "Skills",
      desc: "Enable skills for the AI to use",
      Icon: Lightbulb,
    ...
    },
    {
      id: "_mcp",
      label: "MCP Servers",
      desc: "Connect Model Context Protocol servers",
      Icon: Plug,
      onClick: () => {
        p.setPlusMenuOpen(false);
    ...
    return (
      ...
      >
        ...
        <span className="flex-1 min-w-0 flex flex-col gap-0.5">
          ...
          <span className="text-[13px] font-normal leading-[1.2] text-foreground/55 truncate">
            {row.desc}
          </span>
        </span>
        {row.toggle ? (
  ...
  <motion.div key="main" {...fadeProps(-8)} className="flex flex-col">
    {/* MOBILE — clean list, our features */}
    <div
