    ...
    <div data-theme="dark" className="min-h-dvh overflow-x-hidden bg-background text-foreground">
      ...
      <main className="px-4 pt-32 pb-20 mx-auto max-w-5xl">
        <header className="text-center mb-14">
          ...
          <p className="mt-4 text-[12px] text-muted-foreground/70 italic max-w-xl mx-auto">
            {data.honestNote}
          </p>
        </header>
        ...
        <section className="rounded-2xl border border-primary/30 bg-primary/[0.04] p-7 md:p-9 mb-14">
          ...
          <div className="mt-6 flex flex-wrap gap-3">
            <Link
              to="/auth"
              className="px-5 h-11 inline-flex items-center rounded-full bg-foreground text-background font-semibold text-sm"
            >
              Try Megsy free
            </Link>
            <Link
              to="/pricing"
              className="px-5 h-11 inline-flex items-center rounded-full border border-border/60 text-sm font-semibold"
            >
              See pricing
            </Link>
          </div>
        ...
        {/* Other comparisons */}
        <section>
          <h3 className="font-display text-sm uppercase tracking-[0.16em] text-muted-foreground mb-4">
