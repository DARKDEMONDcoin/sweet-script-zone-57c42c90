...
const TIER_META: Record<Tier, { price: string; subtitle: string }> = {
  ...
  Elite: { price: "$59", subtitle: "Most popular" },
  Business: { price: "$149", subtitle: "For teams" },
};
...
const SERVICES: ServiceDetail[] = [
  ...
  },
  {
    ...
    description:
      "Generate high-resolution images using the top image models. During your plan window (7 / 15 / 30 days depending on plan), create freely within fair-use limits. Outside the window, generation uses MC credits.",
    highlights: [
    ...
    media: {
      kind: "image",
      src: "/api-showcase/image-gen-preview.webp",
  ...
  },
  {
    ...
    media: {
      ...
      alt: "Video generation preview",
    },
    values: {
      Free: false,
      Pro: `${PLAN_MONTHLY_CREDITS.pro} MC included`,
      Elite: `${PLAN_MONTHLY_CREDITS.elite} MC included`,
      Business: `${PLAN_MONTHLY_CREDITS.business.toLocaleString("en-US")} MC included`,
    },
  },
  {
    ...
    description:
      "Describe your topic and get a complete presentation with structured slides, images, and speaker notes. Export to PowerPoint or PDF. Free users get 3 generations per day; paid plans unlock generous creation windows.",
    highlights: [
  ...
  },
  {
    ...
    description:
      "Describe your app and Megsy writes, edits, and deploys it. One-click publishing, custom domains, and full GitHub sync during your plan window.",
    highlights: [
    ...
    media: { kind: "image", src: "/showcase/service-canvas.webp", alt: "Code builder preview" },
    values: {
      Free: false,
      Pro: "Unlimited 7 days / month",
      Elite: "Unlimited 15 days / month",
  ...
  },
  {
    ...
    media: { kind: "image", src: "/showcase/service-social.webp", alt: "Megsy OS preview" },
    values: {
      Free: false,
      Pro: "Unlimited tasks",
  ...
  },
  {
    ...
    description:
      "MC covers video generation and any usage beyond your plan windows. Credits reset monthly. No hidden charges — you only ever spend what's in your plan.",
    highlights: [
    ...
    values: {
      Free: "0 MC",
      Pro: `${PLAN_MONTHLY_CREDITS.pro} MC / month`,
      Elite: `${PLAN_MONTHLY_CREDITS.elite} MC / month`,
      Business: `${PLAN_MONTHLY_CREDITS.business.toLocaleString("en-US")} MC / month`,
    },
  },
  {
    name: "Team Workspace",
    ...
    media: { kind: "image", src: "/showcase/service-editor.webp", alt: "Team workspace preview" },
    values: {
      Free: false,
      Pro: "Included",
      Elite: "Included",
  ...
  },
  {
    ...
    media: { kind: "image", src: "/showcase/service-upscaler.webp", alt: "Priority queue preview" },
    values: {
      Free: false,
      Pro: "Standard speed",
      Elite: "3× priority",
  ...
  },
  {
    ...
    media: { kind: "image", src: "/showcase/service-audio.webp", alt: "Support preview" },
    values: {
      Free: "Community",
      Pro: "Priority email",
      Elite: "24/7 chat",
...
const MediaBlock = ({ media }: { media: Media }) => (
  <div className="relative overflow-hidden rounded-ios-lg border border-border bg-card aspect-[4/3] sm:aspect-[16/10] shadow-[0_40px_100px_-40px_hsl(var(--foreground)/0.35)]">
    {media.kind === "image" ? (
      <img
        src={media.src}
        alt={media.alt}
    ...
    <div
      aria-hidden
      className="pointer-events-none absolute inset-0 ring-1 ring-inset ring-foreground/5 rounded-ios-lg"
    />
  </div>
);
      ...
      <div data-theme="dark" className="min-h-dvh overflow-x-hidden bg-background text-foreground">
        ...
        <main id="main" className="pt-24 sm:pt-28">
          ...
          <section className="relative max-w-5xl mx-auto px-5 sm:px-8 pt-12 sm:pt-20 pb-16 sm:pb-24 text-center">
            ...
            >
              Eleven services, four plans, one transparent system. Scroll through every tool with a
              live preview, then compare plans side by side.
            </motion.p>
          ...
          <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-24">
            ...
            <div className="md:hidden space-y-3">
              {SERVICES.map((s) => (
                <details key={s.name} className="rounded-2xl border border-border bg-card/70 p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2 text-sm">
                    {TIERS.map((t) => (
                      ...
                      >
                        ...
                        <div className="mt-1 text-foreground">{renderCell(s.values[t])}</div>
                      </div>
                    ))}
                  </div>
                </details>
                    ...
                    <tr className="border-b border-border">
                      ...
                      {TIERS.map((t) => {
                        ...
                        return (
                          <th
                            key={t}
                            className="px-5 py-6 text-center min-w-[150px] border-l border-border/60"
                          >
