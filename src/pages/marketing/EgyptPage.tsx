      ...
      <section className="relative min-h-[110vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0">
          <img loading="eager" fetchPriority="high" decoding="async"
            src="/egypt/pyramids-night.webp"
            alt="The Great Pyramids of Giza at night"
        ...
        <div className="relative z-10 text-center px-6 max-w-6xl mx-auto">
          ...
          <motion.p
            ...
            className="text-lg md:text-2xl text-foreground/50 max-w-3xl mx-auto leading-relaxed"
          >
            Seven thousand years of history. A nation rising with vision, strength, and
            determination. We are proud of our country and the leadership guiding it toward an
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-start">
            ...
            >
              ...
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed mb-6">
                ...
                From the banks of the Nile to the vast Sahara, from the Mediterranean shores to the
                Red Sea reefs, Egypt has always been a land of wonder, innovation, and resilience.
              </p>
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed mb-6">
                Today, Egypt stands at the forefront of a massive transformation. With unprecedented
                infrastructure development, a booming digital economy, and strategic reforms that
                have attracted billions in foreign investment, the nation is writing a new chapter
                in its legendary story.
              </p>
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed">
                Under visionary leadership, Egypt has launched the most ambitious development
                program in its modern history — building new cities, expanding the Suez Canal,
                revolutionizing transportation, and investing heavily in education, healthcare, and
                technology.
              </p>
            </motion.div>
            <motion.div
            ...
            >
              <div className="relative rounded-2xl overflow-hidden aspect-[4/5]">
                <img loading="lazy" decoding="async"
                  src="/egypt/luxor.webp"
                  alt="Luxor Temple at night"
                  className="w-full h-full object-cover"
                />
                ...
                <div className="absolute bottom-8 left-8 right-8">
                  ...
                  <p className="text-sm text-foreground/50">
                    One of Egypt's most spectacular ancient monuments, attracting millions of
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            >
              ...
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed mb-6">
                ...
                modern development. Since taking office, he has championed massive national projects
                that have fundamentally transformed Egypt's infrastructure, economy, and global
                standing.
              </p>
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed mb-6">
                Under his leadership, Egypt has restored security and stability, launched
                unprecedented mega-projects, attracted record foreign investment, and positioned the
                nation as a key player in regional and international affairs. His vision for a "New
                Republic" has mobilized the entire nation toward building a prosperous and modern
                Egypt.
              </p>
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed mb-6">
              ...
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed">
                We are deeply proud of our president and his tireless dedication to the people of
                Egypt. His commitment to progress, reform, and national dignity continues to inspire
                millions of Egyptians and earn respect on the world stage.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 50 }}
          ...
          <div className="grid md:grid-cols-2 gap-16 md:gap-24">
            ...
            >
              ...
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed mb-8">
                ...
                world. With a massive domestic market, strategic geographic location, competitive
                costs, and a government deeply committed to economic reform and investor-friendly
                policies, Egypt is a destination of choice for global investors.
              </p>
              <p className="text-foreground/40 text-base md:text-lg leading-relaxed">
                The Egyptian government has implemented sweeping reforms including a new investment
                law, streamlined business registration, reduced bureaucracy, and established special
                economic zones with generous tax incentives. Foreign direct investment has surged,
                and international organizations consistently rank Egypt among the top
                reform-oriented economies in the region.
              </p>
            </motion.div>
            <motion.div
              initial={{ opacity: 0, x: 40 }}
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-foreground/40 text-lg leading-relaxed">
              ...
              high-growth sectors, each backed by government support and strategic national
              initiatives.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {investmentSectors.map((sector, i) => (
              ...
              >
                ...
                <p className="text-foreground/35 text-sm leading-relaxed">{sector.text}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 md:py-44 bg-white/[0.015]">
        <div className="max-w-5xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-foreground/40 text-lg leading-relaxed max-w-3xl mx-auto">
          ...
          <div className="space-y-12">
            {[
              ...
              >
                ...
                <p className="text-foreground/40 text-base leading-relaxed">{item.content}</p>
              </motion.div>
            ))}
          </div>
        </div>
      ...
      <section className="py-32 md:py-44">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            ...
            <p className="text-foreground/40 text-lg leading-relaxed max-w-3xl mx-auto">
              From the iconic Pyramids of Giza to the stunning coral reefs of the Red Sea, Egypt
              offers experiences that are truly unmatched anywhere on Earth.
            </p>
          </motion.div>
            ...
            {[
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <p className="text-foreground/35 text-sm leading-relaxed">{item.text}</p>
                </div>
              </motion.div>
            ))}
          </div>
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            ...
            <p className="text-foreground/40 text-lg leading-relaxed max-w-2xl mx-auto mb-6">
              ...
              ancient land gave birth to the greatest civilization humanity has ever known, and it
              continues to produce heroes who shape the future.
            </p>
            <p className="text-foreground/40 text-lg leading-relaxed max-w-2xl mx-auto mb-6">
              We are proud of our president, proud of our armed forces, proud of our people, and
              proud of the incredible journey of development and progress that Egypt is undertaking.
              The world watches in admiration as Egypt rises.
            </p>
            <p className="text-foreground/30 text-base italic mt-12">
